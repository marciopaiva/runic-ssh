...
export const SOURCE_CATALOG = {
  ...
  "command.split.grid": "Split into four panes",
  "command.split.nine": "Split into nine panes",
  ...
  "empty.pane.hint": "Drag a host here from the session list.",
  ...
  "status.sync": "Typing into every pane",
  ...
  "status.sync.nowhere": "Open a session in a second pane first",
  ...
  "terminal.pane.sync.off": "Type into every pane at once",
  "terminal.pane.sync.on": "This pane receives what you type. Press to spare it",
